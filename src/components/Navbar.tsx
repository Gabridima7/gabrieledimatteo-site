                        ...
                        <div className="flex-1 grid grid-cols-3 gap-0 divide-x divide-[#E5E7EB]">
                          ...
                          <div className="pr-6">
                            ...
                            <div className="space-y-1">
                              ...
                              <MegaItem to="/servizi/sviluppo-web-app" icon={<img src={iconLandingPage} alt="Landing Page" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Landing Page" desc={lang === 'it' ? 'Sito ad alta conversione' : 'High-converting website'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/sviluppo-web-app" icon={<img src={iconWebApp} alt="Web App" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Web App" desc={lang === 'it' ? 'Applicazioni su misura' : 'Custom applications'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/sviluppo-web-app" icon={<img src={iconSoftwareGestionaleNew} alt="Software Gestionale" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={lang === 'it' ? 'Software Gestionale' : 'Management Software'} desc={lang === 'it' ? 'CRM, ERP e tool interni su misura' : 'Custom CRM, ERP & internal tools'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/sviluppo-web-app" icon={<img src={iconProdottoSaas} alt="Prodotto SaaS" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={lang === 'it' ? 'Prodotto SaaS' : 'SaaS Product'} desc={lang === 'it' ? 'Da idea a prodotto scalabile' : 'From idea to scalable product'} onClick={() => setMegaOpen(false)} />
                            </div>
                          </div>
                          ...
                          <div className="px-6">
                            ...
                            <div className="space-y-1">
                              ...
                              <MegaItem to="/servizi/ai-automation" icon={<img src={iconAiChatbot} alt="AI Chatbot" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="AI Chatbot" desc={lang === 'it' ? 'Assistenti virtuali intelligenti' : 'Smart virtual assistants'} onClick={() => setMegaOpen(false)} />
                              ...
                              <MegaItem to="/servizi/ai-automation" icon={<img src={iconIntegrazioniApi} alt="Integrazioni API" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={lang === 'it' ? 'Integrazioni API' : 'API Integrations'} desc={lang === 'it' ? 'Connetti i tuoi sistemi aziendali' : 'Connect your business systems'} onClick={() => setMegaOpen(false)} />
                            </div>
                          </div>
                          ...
                          <div className="pl-6">
                            ...
                            <div className="space-y-1">
                              <MegaItem to="/servizi/branding-ui-ux" icon={<img src={iconUiUxDesign} alt="UI/UX Design" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="UI/UX Design" desc={lang === 'it' ? 'Web & mobile app design' : 'Web & mobile app design'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/sviluppo-web-app" icon={<img src={iconWebsiteDesign} alt="Website Design" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Website Design" desc={lang === 'it' ? 'Siti custom e landing page' : 'Custom sites & landing pages'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/branding-ui-ux" icon={<img src={iconSviluppoWebApp} alt="Mobile App Design" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Mobile App Design" desc={lang === 'it' ? 'App che gli utenti amano' : 'Apps your users love'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/branding-ui-ux" icon={<img src={iconWebsiteRedesign} alt="Website Redesign" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Website Redesign" desc={lang === 'it' ? 'Look moderno, impatto maggiore' : 'Modern look, higher impact'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/consulenza-digitale" icon={<img src={iconSoftwareGestionale} alt="Product UX/UI Audit" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Product UX/UI Audit" desc={lang === 'it' ? 'Insights che guidano i risultati' : 'Insights that drive results'} onClick={() => setMegaOpen(false)} />
                            </div>
                          </div>
                        </div>
                      </div>
