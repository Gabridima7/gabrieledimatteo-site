                        ...
                        <div className="flex-1 grid grid-cols-3 gap-0 divide-x divide-[#E5E7EB]">
                          ...
                          <div className="pr-6">
                            ...
                            <div className="space-y-1">
                              <MegaItem to="/servizi/sviluppo-web" icon={<img src={iconSviluppoWebAppNew} alt="Sviluppo Web & App" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={t('mega', 'sviluppo')} desc={lang === 'it' ? 'Sviluppo Front-End e Back-End' : 'Front-End & Back-End Development'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/landing-page" icon={<img src={iconLandingPage} alt="Landing Page" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Landing Page" desc={lang === 'it' ? 'Sito ad alta conversione' : 'High-converting website'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/web-app" icon={<img src={iconWebApp} alt="Web App" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Web App" desc={lang === 'it' ? 'Applicazioni su misura' : 'Custom applications'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/software-gestionale" icon={<img src={iconSoftwareGestionaleNew} alt="Software Gestionale" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={lang === 'it' ? 'Software Gestionale' : 'Management Software'} desc={lang === 'it' ? 'CRM, ERP e tool interni su misura' : 'Custom CRM, ERP & internal tools'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/prodotto-saas" icon={<img src={iconProdottoSaas} alt="Prodotto SaaS" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={lang === 'it' ? 'Prodotto SaaS' : 'SaaS Product'} desc={lang === 'it' ? 'Da idea a prodotto scalabile' : 'From idea to scalable product'} onClick={() => setMegaOpen(false)} />
                            </div>
                          </div>
                          ...
                          <div className="px-6">
                            ...
                            <div className="space-y-1">
                              <MegaItem to="/servizi/ai-automation" icon={<img src={iconAiAutomation} alt="AI Automation" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={t('mega', 'ai')} desc={lang === 'it' ? 'Automatizza i processi con l\'AI' : 'Automate processes with AI'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/ai-chatbot" icon={<img src={iconAiChatbot} alt="AI Chatbot" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="AI Chatbot" desc={lang === 'it' ? 'Assistenti virtuali intelligenti' : 'Smart virtual assistants'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/consulenza-digitale" icon={<img src={iconConsulenzaDigitale} alt="Consulenza Digitale" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={t('mega', 'consulenza')} desc={lang === 'it' ? 'Strategia e roadmap per la tua PMI' : 'Strategy & roadmap for your SME'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/integrazioni-api" icon={<img src={iconIntegrazioniApi} alt="Integrazioni API" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={lang === 'it' ? 'Integrazioni API' : 'API Integrations'} desc={lang === 'it' ? 'Connetti i tuoi sistemi aziendali' : 'Connect your business systems'} onClick={() => setMegaOpen(false)} />
                            </div>
                          </div>
                          ...
                          <div className="pl-6">
                            ...
                            <div className="space-y-1">
                              <MegaItem to="/servizi/ui-ux-design" icon={<img src={iconUiUxDesign} alt="UI/UX Design" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="UI/UX Design" desc={lang === 'it' ? 'Web & mobile app design' : 'Web & mobile app design'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/website-design" icon={<img src={iconWebsiteDesign} alt="Website Design" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Website Design" desc={lang === 'it' ? 'Siti custom e landing page' : 'Custom sites & landing pages'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/mobile-app-design" icon={<img src={iconSviluppoWebApp} alt="Mobile App Design" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Mobile App Design" desc={lang === 'it' ? 'App che gli utenti amano' : 'Apps your users love'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/website-redesign" icon={<img src={iconWebsiteRedesign} alt="Website Redesign" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Website Redesign" desc={lang === 'it' ? 'Look moderno, impatto maggiore' : 'Modern look, higher impact'} onClick={() => setMegaOpen(false)} />
                              <MegaItem to="/servizi/product-audit" icon={<img src={iconSoftwareGestionale} alt="Product UX/UI Audit" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title="Product UX/UI Audit" desc={lang === 'it' ? 'Insights che guidano i risultati' : 'Insights that drive results'} onClick={() => setMegaOpen(false)} />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="mx-10 my-6 bg-[#F9FAFB] rounded-xl px-6 py-5">
                      <div className="flex items-start gap-10">
                        ...
                        <div className="flex-1 grid grid-cols-3 gap-4">
                          <SolutionCard to="/soluzioni/mvp" icon={<img src={iconMvpDesign} alt="MVP Design" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={t('mega', 'mvp')} subtitle={lang === 'it' ? 'Per startup e imprenditori' : 'For startups & entrepreneurs'} desc={lang === 'it' ? 'Crea un prodotto digitale, attrai investitori e nuovi clienti.' : 'Create a digital product, attract investors and new clients.'} onClick={() => setMegaOpen(false)} />
                          <SolutionCard to="/soluzioni/product-redesign" icon={<img src={iconProductRedesign} alt="Product Redesign" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={t('mega', 'redesign')} subtitle={lang === 'it' ? 'Per PMI e aziende' : 'For SMEs & enterprises'} desc={lang === 'it' ? 'Un look fresco, UX migliorata e funzionalità potenziate.' : 'A fresh look, improved UX, and enhanced functionality.'} onClick={() => setMegaOpen(false)} />
                          <SolutionCard to="/soluzioni/estensione-team" icon={<img src={iconRetainer} alt="Estensione Team" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={t('mega', 'retainer')} subtitle={lang === 'it' ? 'Per aziende esistenti' : 'For existing companies'} desc={lang === 'it' ? 'Espandi il tuo team con i nostri esperti dedicati.' : 'Expand your team with our dedicated experts.'} onClick={() => setMegaOpen(false)} />
                        </div>
                      </div>
                    </div>
                    ...
                    {servicesExpanded && (
                      ...
                      >
                        <div className="bg-[#F9FAFB] px-6 pb-5 pt-3">
                          ...
                          <MobileServiceItem to="/servizi/sviluppo-web" icon={<img src={iconSviluppoWebAppNew} alt="Sviluppo Web" className="w-6 h-6 object-contain" />} gradient="from-transparent to-transparent" title="Sviluppo Web" desc="Siti web e app su misura" onClick={() => setIsOpen(false)} />
                          <MobileServiceItem to="/servizi/landing-page" icon={<img src={iconLandingPage} alt="Landing Page" className="w-6 h-6 object-contain" />} gradient="from-transparent to-transparent" title="Landing Page" desc="High-converting website" onClick={() => setIsOpen(false)} />
                          <MobileServiceItem to="/servizi/web-app" icon={<img src={iconWebApp} alt="Web App" className="w-6 h-6 object-contain" />} gradient="from-transparent to-transparent" title="Web App" desc="Applicazioni su misura" onClick={() => setIsOpen(false)} />
                          <MobileServiceItem to="/servizi/software-gestionale" icon={<img src={iconSoftwareGestionaleNew} alt="Software Gestionale" className="w-6 h-6 object-contain" />} gradient="from-transparent to-transparent" title="Software Gestionale" desc="CRM, ERP e tool interni" onClick={() => setIsOpen(false)} />
                          <MobileServiceItem to="/servizi/prodotto-saas" icon={<img src={iconProdottoSaas} alt="Prodotto SaaS" className="w-6 h-6 object-contain" />} gradient="from-transparent to-transparent" title="Prodotto SaaS" desc="Da idea a prodotto scalabile" onClick={() => setIsOpen(false)} last />
                          ...
                          <MobileServiceItem to="/servizi/ai-chatbot" icon={<img src={iconAiChatbot} alt="AI Chatbot" className="w-6 h-6 object-contain" />} gradient="from-transparent to-transparent" title="AI Chatbot" desc="Assistenti virtuali intelligenti" onClick={() => setIsOpen(false)} />
                          ...
                          <MobileServiceItem to="/servizi/integrazioni-api" icon={<img src={iconIntegrazioniApi} alt="Integrazioni API" className="w-5 h-5 object-contain" />} gradient="from-transparent to-transparent" title="Integrazioni API" desc="Connetti i tuoi sistemi" onClick={() => setIsOpen(false)} last />

                          {/* DESIGN */}
                          <p className="text-[11px] font-bold tracking-[0.08em] uppercase text-[#9CA3AF] mb-3 mt-5">DESIGN</p>
                          <MobileServiceItem to="/servizi/ui-ux-design" icon={<img src={iconUiUxDesign} alt="UI/UX Design" className="w-5 h-5 object-contain" />} gradient="from-transparent to-transparent" title="UI/UX Design" desc="Web & mobile app design" onClick={() => setIsOpen(false)} />
