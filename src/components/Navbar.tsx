                        ...
                        <div className="flex-1 grid grid-cols-3 gap-0 divide-x divide-[#E5E7EB]">
                          ...
                          <div className="pr-6">
                            ...
                            <div className="space-y-1">
                              <MegaItem to="/servizi/sviluppo-web-app" icon={<img src={iconSviluppoWebAppNew} alt="Sviluppo Web & App" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={t('mega', 'sviluppo')} desc={lang === 'it' ? 'Sviluppo Front-End e Back-End' : 'Front-End & Back-End Development'} onClick={() => setMegaOpen(false)} />
                    ...
                    {servicesExpanded && (
                      ...
                      >
                        <div className="bg-[#F9FAFB] px-6 pb-5 pt-3">
                          ...
                          <MobileServiceItem to="/servizi/sviluppo-web-app" icon={<img src={iconSviluppoWebAppNew} alt="Sviluppo Web" className="w-6 h-6 object-contain" />} gradient="from-transparent to-transparent" title="Sviluppo Web" desc="Siti web e app su misura" onClick={() => setIsOpen(false)} />
