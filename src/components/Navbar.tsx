                        ...
                        <div className="flex-1 grid grid-cols-3 gap-0 divide-x divide-[#E5E7EB]">
                          ...
                          <div className="pr-6">
                            ...
                            <div className="space-y-1">
                              <MegaItem to="/servizi/sviluppo-web-app" icon={<img src={iconSviluppoWebAppNew} alt="Sviluppo Web & App" className="w-7 h-7 object-contain" />} gradient="from-transparent to-transparent" title={t('mega', 'sviluppo')} desc={lang === 'it' ? 'Siti web e applicazioni su misura' : 'Custom websites & applications'} onClick={() => setMegaOpen(false)} />
