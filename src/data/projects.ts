...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    tagline: "Sito Web *Professionale* con Gestionale *Interno Custom*",
    ...
    industry: "Serramenti & Architettura",
    services: ["Sviluppo Web", "UI/UX Design", "Software Gestionale", "Internazionalizzazione IT/EN"],
    country: "🇮🇹 Italia",
    year: "2026",
    about: "*Biglia Serramenti* è un'azienda con 50 anni di storia nella produzione e installazione di serramenti in alluminio, *Schueco Premium Partner* certificata. Nexus ha sviluppato per loro un sito web professionale multilingua (IT/EN) con oltre 70 pagine pubbliche, un catalogo prodotti strutturato su più livelli con finestre e facciate continue, un portfolio di 40+ realizzazioni reali e un'area gestionale privata per la gestione interna di commesse, clienti e catalogo. Il progetto integra tecnologie avanzate come un *visualizzatore 3D interattivo*, effetti parallax a 6 livelli, toggle acustico interattivo e filtri dinamici in tempo reale.",
    challenge: "Biglia Serramenti non aveva un sito web all'altezza del loro posizionamento da Premium Partner Schueco: nessuna presenza digitale credibile, nessun catalogo navigabile per architetti e progettisti, nessun portfolio accessibile delle realizzazioni. Internamente, la gestione di commesse e clienti avveniva con strumenti non integrati, senza un pannello di controllo dedicato accessibile dal sito stesso.",
    solution: "Nexus ha costruito un ecosistema digitale completo su due livelli. Il *sito pubblico* presenta un catalogo multi-livello con 7 modelli di finestre con schede tecniche dettagliate e 34+ prodotti per facciate continue con filtri multi-criterio, un portfolio di 40+ progetti filtrabili per regione, sistema e stato, e pagine speciali come Dogall System con viewer 3D e la pagina Schueco Premium Partner. L'*area gestionale privata* — accessibile solo con credenziali — permette al team Biglia di gestire commesse, clienti, dati amministrativi e il catalogo prodotti direttamente dal browser, con autenticazione sicura via Supabase.",
    phases: [
      { number: "1", title: "Discovery & Architettura", items: ["Mappatura di tutte le sezioni: sito pubblico + area gestionale privata", "Strutturazione del catalogo prodotti a più livelli (finestre, facciate, schermature, scorrevoli)", "Definizione dei dataset: 40+ progetti, 35 prodotti facciate, 8 sistemi finestre", "Architettura bilingue IT/EN con sistema i18n (~90 chiavi di traduzione)"] },
      { number: "2", title: "UI/UX Design", items: ["Design del sito con identità visiva premium coerente con il posizionamento Schueco", "Homepage a 6 sezioni con effetti parallax e navigazione a punti laterale", "Menu a tendina multinivello con anteprime immagini per Sistemi & Soluzioni", "Design mobile-first per tutti i 70+ template di pagina"] },
      { number: "3", title: "Sviluppo Sito Pubblico", items: ["Homepage con 6 sezioni parallax e badge Schueco Premium Partner sempre visibile", "Catalogo Finestre: 7 modelli (Anta in Vista, Anta a Scomparsa, Panoramica) con toggle acustico interattivo e selettore classe antieffrazione RC", "Catalogo Facciate: 34+ prodotti con filtri combinabili per materiale, tipo, efficienza energetica e design", "Portfolio Progetti: 40+ realizzazioni con filtri per regione, sistema e stato — galleria lightbox a schermo intero", "Pagina Dogall System con viewer 3D interattivo (Three.js) e animazioni grafiche", "Pagine Azienda: Chi Siamo, Processo Produttivo con carosello interattivo, Sostenibilità", "Pagine speciali: Schueco Premium Partner, Certificazioni (ISO 9001, SOA, EN 14351), Download Cataloghi", "Pagina Contatti con form validato (Zod), mappa sede Agliano Terme, e sezione Lavora con Noi", "Internazionalizzazione completa IT/EN su tutte le pagine pubbliche"] },
      { number: "4", title: "Sviluppo Area Gestionale", items: ["Autenticazione sicura con Supabase — reindirizzamento automatico al login se non autenticati", "Dashboard con riepilogo commesse attive, clienti registrati e statistiche", "Modulo Commesse & Clienti: creazione, modifica, eliminazione con ricerca e filtri avanzati", "Sezione Amministrativo: costi, stati di pagamento, informazioni economiche per commessa", "Catalogo interno: sfogliare prodotti finestre e facciate con schede complete", "Gestione Portfolio: aggiornamento dei progetti visibili sul sito pubblico", "Impostazioni profilo: cambio password e toggle tema chiaro/scuro"] },
    ],
    galleryImages: [
    ...
    results: [
      { metric: "70+", label: "Pagine pubbliche", description: "Sito multilingua IT/EN con oltre 70 template di pagina: catalogo, portfolio, azienda, contatti e pagine speciali." },
      { metric: "40+", label: "Progetti in portfolio", description: "Realizzazioni reali filtrabili per regione, sistema e stato, con galleria lightbox a schermo intero e link Street View." },
      { metric: "34+", label: "Prodotti a catalogo", description: "Facciate continue e sistemi finestre con filtri multi-criterio, schede tecniche dettagliate e capitolati scaricabili." },
      { metric: "2", label: "Sistemi in uno", description: "Sito pubblico professionale + area gestionale privata (commesse, clienti, catalogo) in un'unica piattaforma integrata." },
    ],
    testimonial: undefined,
  },
  {
