        ...
        <div className="section-container text-center">
          ...
          >
            <img 
              src={logo} 
              alt="Nexus" 
              className="h-20 w-auto mx-auto brightness-[2] contrast-125"
            />
          </motion.div>
          ...
          >
            Progettiamo agenti AI, automazioni e prodotti digitali per PMI italiane.
            <br />
            Dalla strategia alla build in settimane, non mesi.
          </motion.p>
          ...
          >
            <Link
              to="/prenota-call"
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 glow-box inline-flex items-center justify-center gap-2"
            ...
            <Link
              to="/soluzioni"
              className="glass hover:bg-white/10 text-foreground px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 inline-flex items-center justify-center gap-2"
              data-cursor="spotlight"
            >
              Scopri le Soluzioni
            </Link>
        ...
        <div className="section-container">
          ...
          >
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-12">
              {[
                'Time-to-value in 7–21 giorni',
                'Prototipi → MVP → produzione',
      ...
      <section className="py-24">
        <div className="section-container">
          ...
          >
            ...
            <Link
              to="/prenota-call"
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-10 py-4 rounded-full text-lg font-medium transition-all duration-300 glow-box inline-flex items-center justify-center gap-2"
              data-cursor="spotlight"
            >
              Prenota Call
              <ArrowRight size={20} />
