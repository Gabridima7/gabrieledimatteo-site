...
import iconAiEducation from '@/assets/icons/icon-ai-education.webp';
import iconAiAgents from '@/assets/icons/icon-ai-agents.webp';
import iconAiProducts from '@/assets/icons/icon-ai-products.webp';
import iconSoluzioniCustom from '@/assets/icons/icon-soluzioni-custom.webp';
