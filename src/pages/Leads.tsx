...
const Leads = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await invokeBackendFunction('send-leads-file', {
        email: email.trim(),
      });
  ...
  return (
    <>
      <Helmet>
        <title>File Gratuito — 40.000 Aziende Italiane Senza Sito Web | Nexus Agency</title>
        <meta name="description" content="Scarica il file Excel con nome, settore e città di oltre 40.000 attività italiane senza sito web. Gratis." />
        <meta property="og:title" content="File Gratuito — 40.000 Aziende Italiane Senza Sito Web | Nexus Agency" />
        <meta property="og:description" content="Scarica il file Excel con nome, settore e città di oltre 40.000 attività italiane senza sito web. Gratis." />
        <meta property="og:image" content="https://nexusagency.it/og-guida.png" />
        <meta property="og:url" content="https://nexusagency.it/leads" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <link rel="canonical" href="https://nexusagency.it/leads" />
      </Helmet>
      ...
      <div className="fixed inset-0 flex flex-col" style={{ backgroundColor: '#0a0a0f' }}>
        <div
          ...
          style={{
            background: 'radial-gradient(circle at 80% 10%, #6366f1 0%, transparent 70%)',
          }}
        />
          ...
          <div className="w-full max-w-lg text-center">
            {status === 'success' ? (
              <div className="animate-fade-in space-y-4">
                ...
                <h2 className="text-2xl font-bold text-white">Perfetto! Controlla la tua email, ti abbiamo inviato il file 📩</h2>
                <p className="text-sm" style={{ color: '#a0a0b0' }}>
                  Abbiamo inviato il file a <span className="text-white font-medium">{submittedEmail}</span>. Controlla anche lo spam.
                </p>
                <a
              ...
              <div className="space-y-6">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-[42px] font-bold leading-tight text-white">
                  Scarica il File con le 40.000 Aziende Italiane Senza Sito Web
                </h1>

                <p className="text-sm sm:text-base" style={{ color: '#a0a0b0' }}>
                  Il file Excel con nome, settore e città di oltre 40.000 attività italiane senza sito web. Gratis.
                </p>
                ...
                <p className="text-[11px]" style={{ color: '#666' }}>
                  Zero spam. Riceverai solo il file. Puoi cancellarti quando vuoi.
                </p>

                <p className="text-xs" style={{ color: '#555' }}>
                  📥 Scaricato da 100+ persone
                </p>
              </div>
            )}
          </div>
