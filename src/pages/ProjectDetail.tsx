          ...
          <div className="section-container">
            <div className="flex flex-col xl:flex-row xl:items-end gap-6 xl:gap-0">
              ...
              <div className="relative xl:w-[65%] order-1 xl:order-2">
                <div className={`relative rounded-[20px] overflow-hidden ${slug === 'homeleven' ? '' : 'aspect-[16/10] xl:aspect-[2/1]'}`}>
                  <img src={project.heroImage} alt={project.name} className={`w-full ${slug === 'homeleven' ? 'h-auto object-contain' : 'h-full object-cover'}`} />
                  {/* Year badge */}
